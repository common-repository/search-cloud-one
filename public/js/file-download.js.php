$(document).ready(function() {
   ...
   downloadBtn.click(function () {
      ...
      $.ajax({
          type: "GET",
          url: '<?php echo(rest_url("sc1_client/v1/download_tokens"));?>',
          timeout: 10000,
          data: {
              fileUUID: fUUID
          },
          success: function (data, textStatus, xhr) {
              top.location.href = "https://api.searchcloudone.com/Files?Token=" + data + "&FileUUID=" + fUUID;
          },
    ...
    */
    ...
    propertiesBtn.click(function() {
       ...
       $.ajax({
           type: "GET",
           url: '<?php echo(rest_url("sc1_client/v1/file_properties")); ?>',
           timeout: 10000,
           data: {
               fileUUID: fUUID
           },
